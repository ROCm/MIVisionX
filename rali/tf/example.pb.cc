...
extern PROTOBUF_INTERNAL_EXPORT_example_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Example_example_2eproto;
...
class ExamplesDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<Examples> _instance;
} _Examples_default_instance_;
...
static void InitDefaultsscc_info_Examples_example_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::tensorflow::_Examples_default_instance_;
    new (ptr) ::tensorflow::Examples();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::tensorflow::Examples::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Examples_example_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Examples_example_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_example_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::tensorflow::Examples, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::tensorflow::Examples, example_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 6, -1, sizeof(::tensorflow::Examples)},
  { 12, -1, sizeof(::tensorflow::SequenceExample)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::tensorflow::_Example_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::tensorflow::_Examples_default_instance_),
...
const char descriptor_table_protodef_example_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "(\0132\023.tensorflow.Example\"i\n\017SequenceExamp"
  "le\022%\n\007context\030\001 \001(\0132\024.tensorflow.Feature"
  "s\022/\n\rfeature_lists\030\002 \001(\0132\030.tensorflow.Fe"
  "atureListsB\201\001\n\026org.tensorflow.exampleB\rE"
  "xampleProtosP\001ZSgithub.com/tensorflow/te"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_example_2eproto_sccs[3] = {
  &scc_info_Example_example_2eproto.base,
  &scc_info_Examples_example_2eproto.base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_example_2eproto = {
  &descriptor_table_example_2eproto_initialized, descriptor_table_protodef_example_2eproto, "example.proto", 390,
  &descriptor_table_example_2eproto_once, descriptor_table_example_2eproto_sccs, descriptor_table_example_2eproto_deps, 3, 1,
...
void Examples::InitAsDefaultInstance() {
}
class Examples::_Internal {
 public:
};
...
Examples::Examples()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:tensorflow.Examples)
}
Examples::Examples(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
  _internal_metadata_(arena),
  example_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:tensorflow.Examples)
}
Examples::Examples(const Examples& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
      example_(from.example_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:tensorflow.Examples)
}

void Examples::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Examples_example_2eproto.base);
}

Examples::~Examples() {
  // @@protoc_insertion_point(destructor:tensorflow.Examples)
  SharedDtor();
}

void Examples::SharedDtor() {
  GOOGLE_DCHECK(GetArenaNoVirtual() == nullptr);
}

void Examples::ArenaDtor(void* object) {
  Examples* _this = reinterpret_cast< Examples* >(object);
  (void)_this;
}
void Examples::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void Examples::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const Examples& Examples::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Examples_example_2eproto.base);
  return *internal_default_instance();
}
...
void Examples::Clear() {
// @@protoc_insertion_point(message_clear_start:tensorflow.Examples)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* Examples::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArenaNoVirtual(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    CHK_(ptr);
    switch (tag >> 3) {
      // repeated .tensorflow.Example example = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr -= 1;
          do {
...
::PROTOBUF_NAMESPACE_ID::uint8* Examples::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:tensorflow.Examples)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:tensorflow.Examples)
  return target;
}

size_t Examples::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:tensorflow.Examples)
  size_t total_size = 0;
...
void Examples::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:tensorflow.Examples)
  GOOGLE_DCHECK_NE(&from, this);
  const Examples* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Examples>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:tensorflow.Examples)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:tensorflow.Examples)
    MergeFrom(*source);
  }
}

void Examples::MergeFrom(const Examples& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:tensorflow.Examples)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void Examples::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:tensorflow.Examples)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void Examples::CopyFrom(const Examples& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:tensorflow.Examples)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Examples::IsInitialized() const {
  return true;
}

void Examples::InternalSwap(Examples* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  example_.InternalSwap(&other->example_);
}

::PROTOBUF_NAMESPACE_ID::Metadata Examples::GetMetadata() const {
  return GetMetadataStatic();
}
...
template<> PROTOBUF_NOINLINE ::tensorflow::Examples* Arena::CreateMaybeMessage< ::tensorflow::Examples >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::Examples >(arena);
}
