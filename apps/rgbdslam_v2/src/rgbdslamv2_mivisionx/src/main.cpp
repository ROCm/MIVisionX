...
{
  // Initialize camera input dimensions
  image_width = 640;
  image_height = 480;
  
  // Initialize OpenVX Graph
  init_openvx();
  ...
  // Cannot put this function before ros::init() as it uses parameter from launch file to extract
  // absolute path to OpenCL kernel file
  init_opencl();
