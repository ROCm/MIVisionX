...
extern ExamplesDefaultTypeInternal _Examples_default_instance_;
...
template<> ::tensorflow::Examples* Arena::CreateMaybeMessage<::tensorflow::Examples>(Arena*);
...
class Examples :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.Examples) */ {
 public:
  Examples();
  virtual ~Examples();

  Examples(const Examples& from);
  Examples(Examples&& from) noexcept
    : Examples() {
    *this = ::std::move(from);
  }

  inline Examples& operator=(const Examples& from) {
    CopyFrom(from);
    return *this;
  }
  inline Examples& operator=(Examples&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const Examples& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Examples* internal_default_instance() {
    return reinterpret_cast<const Examples*>(
               &_Examples_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(Examples& a, Examples& b) {
    a.Swap(&b);
  }
  inline void Swap(Examples* other) {
    if (other == this) return;
    if (GetArenaNoVirtual() == other->GetArenaNoVirtual()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(Examples* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArenaNoVirtual() == other->GetArenaNoVirtual());
    InternalSwap(other);
  }
  ...
  inline Examples* New() const final {
    return CreateMaybeMessage<Examples>(nullptr);
  }

  Examples* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<Examples>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const Examples& from);
  void MergeFrom(const Examples& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Examples* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.Examples";
  }
  protected:
  explicit Examples(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  public:
  void clear_example();
  ::tensorflow::Example* mutable_example(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::Example >*
      mutable_example();
  private:
  const ::tensorflow::Example& _internal_example(int index) const;
  ::tensorflow::Example* _internal_add_example();
  public:
  const ::tensorflow::Example& example(int index) const;
  ::tensorflow::Example* add_example();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::Example >&
      example() const;

  // @@protoc_insertion_point(class_scope:tensorflow.Examples)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::Example > example_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_example_2eproto;
};
// -------------------------------------------------------------------
...
// repeated .tensorflow.Example example = 1;
inline int Examples::_internal_example_size() const {
  return example_.size();
}
inline int Examples::example_size() const {
  return _internal_example_size();
}
inline void Examples::clear_example() {
  example_.Clear();
}
inline ::tensorflow::Example* Examples::mutable_example(int index) {
  // @@protoc_insertion_point(field_mutable:tensorflow.Examples.example)
  return example_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::Example >*
Examples::mutable_example() {
  // @@protoc_insertion_point(field_mutable_list:tensorflow.Examples.example)
  return &example_;
}
inline const ::tensorflow::Example& Examples::_internal_example(int index) const {
  return example_.Get(index);
}
inline const ::tensorflow::Example& Examples::example(int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.Examples.example)
  return _internal_example(index);
}
inline ::tensorflow::Example* Examples::_internal_add_example() {
  return example_.Add();
}
inline ::tensorflow::Example* Examples::add_example() {
  // @@protoc_insertion_point(field_add:tensorflow.Examples.example)
  return _internal_add_example();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::Example >&
Examples::example() const {
  // @@protoc_insertion_point(field_list:tensorflow.Examples.example)
  return example_;
}
