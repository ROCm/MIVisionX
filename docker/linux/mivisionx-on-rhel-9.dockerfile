FROM compute-artifactory.amd.com:5000/rocm-plus-docker/compute-rocm-rel-5.4:104-rhel-9.x-stg1
...
RUN yum -y install make g++ unzip libomp-devel wget clang
...
RUN yum update -y && yum -y install autoconf automake bzip2-devel openssl-devel python3-devel gflags-devel glog-devel lmdb-devel nasm yasm jsoncpp-devel && \
