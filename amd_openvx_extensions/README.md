...
* [amd_media](amd_media): `vx_amd_media` is an OpenVX AMD media extension module. This module has mainly two OpenVX extension nodes. `amd.media.decode` node for video/jpeg decoding and `amd.media.encode` node for video encoding
