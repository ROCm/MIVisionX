...
This sample [application](./bubble_pop/README.md) creates bubbles and donuts to pop using OpenVX & OpenCV functionality.

<p align="center"> <img width="90%" src="../docs/images/vx-pop-app.gif"> </p>

## Cloud Application

This sample [application](./cloud_inference/README.md) does inference using a client-server system.

<p align="center"> <a href="http://www.youtube.com/watch?v=0GLmnrpMSYs"> <img width="90%" src="../docs/images/inferenceVideo.png"> </a></p>

## DG Test

This sample [application](./dg_test/README.md) is used to recognize hand written digits.
