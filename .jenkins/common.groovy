...
def runTestCommand (platform, project) {
    ...
    def command = """#!/usr/bin/env bash
                ...
                mkdir build-cts
                cd build-cts
                cmake -DOPENVX_INCLUDES=\$OPENVX_INC/include -DOPENVX_LIBRARIES=\$OPENVX_DIR/lib/libopenvx.so\\;\$OPENVX_DIR/lib/libopenvx_hip.so\\;/opt/rocm/lib/libamdhip64.so\\;pthread\\;dl\\;m\\;rt -DOPENVX_CONFORMANCE_VISION=ON ../OpenVX-cts
                cmake --build .
