...
class Pipeline(object):
    ...
    def CopyToGpuTensorNHWC(self, multiplier, offset, reverse_channels, tensor_dtype):
        if tensor_dtype == types.FLOAT:
            return b.raliCopyToGpuOutputTensor32(self._handle, types.NHWC,
            ...
            return b.raliCopyToGpuOutputTensor16(self._handle, types.NHWC,
                                       multiplier[0], multiplier[1], multiplier[2], offset[0], offset[1], offset[2], (1 if reverse_channels else 0))

    def CopyToGpuTensorNCHW(self, multiplier, offset, reverse_channels, tensor_dtype):
        if tensor_dtype == types.FLOAT:
            return b.raliCopyToGpuOutputTensor32(self._handle, types.NCHW,
                                       multiplier[0], multiplier[1], multiplier[2], offset[0], offset[1], offset[2], (1 if reverse_channels else 0))
        elif tensor_dtype == types.FLOAT16:
            return b.raliCopyToGpuOutputTensor16(self._handle, types.NCHW,
                                       multiplier[0], multiplier[1], multiplier[2], offset[0], offset[1], offset[2], (1 if reverse_channels else 0))
