...
onnx2ir_data_type = [
	"UND_","F032","U008","I008","U016","I016","I032","I064","STR_","BOOL","F016","F064","U032","U064","C064","C128"
]
...
def main():
	if len(sys.argv) < 3:
		print('Usage: python onnx2nnir.py <onnxModel> <nnirOutputFolder> --input_dims n,c,h,w (optional) --output_dims n,c,h,w (optional)')
		sys.exit(1)
