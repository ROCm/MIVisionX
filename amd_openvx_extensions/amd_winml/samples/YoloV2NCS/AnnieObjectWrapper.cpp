...
AnnieObjectWrapper::AnnieObjectWrapper(string input, string modelLoc, int mode) : mInput(input), mModelLoc(modelLoc), mMode(mode) {
	mRegion = make_unique<Region>();
};

AnnieObjectWrapper::~AnnieObjectWrapper() {};

void AnnieObjectWrapper::detect() {
