...
do 
    ...
    do 
        ...
        ./rocAL_unittests 6 $caffe_path ${output_path}Rotate_${rgb_name[$rgb]}_${device_name} $width $height 31 $device $rgb 0 $display
        ./rocAL_unittests 6 $caffe_path ${output_path}Brightness_${rgb_name[$rgb]}_${device_name} $width $height 32 $device $rgb 0 $display
        ./rocAL_unittests 6 $caffe_path ${output_path}Hue_${rgb_name[$rgb]}_${device_name} $width $height 48 $device $rgb 0 $display

        # caffe detection
        ./rocAL_unittests 7 $caffe_path ${output_path}Saturation_${rgb_name[$rgb]}_${device_name} $width $height 49 $device $rgb 0 $display
        ./rocAL_unittests 7 $caffe_path ${output_path}ColorTwist_${rgb_name[$rgb]}_${device_name} $width $height 50 $device $rgb 0 $display
        ./rocAL_unittests 7 $caffe_path ${output_path}Rain_${rgb_name[$rgb]}_${device_name} $width $height 42 $device $rgb 0 $display

        # caffe2 classification
        ./rocAL_unittests 8 $caffe2_path ${output_path}CropCenter_${rgb_name[$rgb]}_${device_name} $width $height 52 $device $rgb 0 $display
        ./rocAL_unittests 8 $caffe2_path ${output_path}ResizeCropMirror_${rgb_name[$rgb]}_${device_name} $width $height 53 $device $rgb 0 $display
        ./rocAL_unittests 8 $caffe2_path ${output_path}Snow_${rgb_name[$rgb]}_${device_name} $width $height 41 $device $rgb 0 $display

        # caffe2 detection
        ./rocAL_unittests 9 $caffe2_path ${output_path}FishEye_${rgb_name[$rgb]}_${device_name} $width $height 10 $device $rgb 0 $display
        ./rocAL_unittests 9 $caffe2_path ${output_path}Pixelate_${rgb_name[$rgb]}_${device_name} $width $height 19 $device $rgb 0 $display
        ./rocAL_unittests 9 $caffe2_path ${output_path}CropCenter_${rgb_name[$rgb]}_${device_name}_cmn $width $height 55 $device $rgb 0 $display
        ...
        ./rocAL_unittests 6 $caffe_path ${output_path}CropMirrorNormalize_${rgb_name[$rgb]}_${device_name}_caffeClassification $width $height 25 $device $rgb 0 $display
        ./rocAL_unittests 7 $caffe_path ${output_path}CropMirrorNormalize_${rgb_name[$rgb]}_${device_name}_caffeDetection $width $height 25 $device $rgb 0 $display
        ./rocAL_unittests 8 $caffe2_path ${output_path}CropMirrorNormalize_${rgb_name[$rgb]}_${device_name}_caffe2Classification $width $height 25 $device $rgb 0 $display
        ./rocAL_unittests 9 $caffe2_path ${output_path}CropMirrorNormalize_${rgb_name[$rgb]}_${device_name}_caffe2Detection $width $height 25 $device $rgb 0 $display
        ./rocAL_unittests 11 $mxnet_path ${output_path}CropMirrorNormalize_${rgb_name[$rgb]}_${device_name}_mxnet $width $height 25 $device $rgb 0 $display
        ...
        ./rocAL_unittests 6 $caffe_path ${output_path}Crop_${rgb_name[$rgb]}_${device_name}_caffeClassification $width $height 51 $device $rgb 0 $display
        ./rocAL_unittests 7 $caffe_path ${output_path}Crop_${rgb_name[$rgb]}_${device_name}_caffeDetection $width $height 51 $device $rgb 0 $display
        ./rocAL_unittests 8 $caffe2_path ${output_path}Crop_${rgb_name[$rgb]}_${device_name}_caffe2Classification $width $height 51 $device $rgb 0 $display
        ./rocAL_unittests 9 $caffe2_path ${output_path}Crop_${rgb_name[$rgb]}_${device_name}_caffe2Detection $width $height 51 $device $rgb 0 $display
        ...
        ./rocAL_unittests 6 $caffe_path ${output_path}Resize_${rgb_name[$rgb]}_${device_name}_bicubic_default_caffeClassification $width $height 0 $device $rgb 0 $display 2 0
        ./rocAL_unittests 7 $caffe_path ${output_path}Resize_${rgb_name[$rgb]}_${device_name}_nearestneighbour_default_caffeDetection $width $height 0 $device $rgb 0 $display 0 0 
        ./rocAL_unittests 8 $caffe2_path ${output_path}Resize_${rgb_name[$rgb]}_${device_name}_lanczos_default_caffe2Classification $width $height 0 $device $rgb 0 $display 3 0
        ./rocAL_unittests 9 $caffe2_path ${output_path}Resize_${rgb_name[$rgb]}_${device_name}_triangular_default_caffe2Detection $width $height 0 $device $rgb 0 $display 5 0
