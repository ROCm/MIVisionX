...
RUN apt-get -y install wget sqlite3 libsqlite3-dev libbz2-dev libssl-dev python-dev python3-dev python3-venv clang autoconf automake libtool curl make g++ unzip && \
...
RUN apt-get -y install python-dev python3-dev libgflags-dev libgoogle-glog-dev liblmdb-dev nasm yasm libjsoncpp-dev clang && \
